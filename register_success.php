                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tr>
                                    ...
                                    <td><?php echo $data['PASSWRD'] ?></td>
                                    <td><a href="register_edit.php?U_ID=<?php echo $data['REGISTRATION_NUMBER'] ?>" class="btn btn-success">Edit</a></td>
                                    <td><a href="register_del.php?D_ID=<?php echo $data['REGISTRATION_NUMBER'] ?>" class="btn btn-danger">Del</a></td>
                            </tr>
                        </table>
                    </div>
                </div>
